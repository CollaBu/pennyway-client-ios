...
protocol EditChatRoomUseCase {
    ...
    func editChatRoom(chatRoomId: Int64, roomData: MakeChatRoomItemModel, completion: @escaping (Bool) -> Void)
}
...
class DefaultEditChatRoomUseCase: EditChatRoomUseCase {
    ...
    func editChatRoom(chatRoomId: Int64, roomData: MakeChatRoomItemModel, completion: @escaping (Bool) -> Void) {
        repository.editChatRoom(chatRoomId: chatRoomId, roomData: roomData) { result in
            switch result {
