...
class DefaultChatRoomUseCase: ChatRoomUseCase {
    ...
    func deleteChatRoom(chatRoomId: Int64, chatMemberId: Int64, completion: @escaping (Bool) -> Void) { repository.deleteChatRoom(chatRoomId: chatRoomId, chatMemberId: chatMemberId, completion: completion)
    }
}
