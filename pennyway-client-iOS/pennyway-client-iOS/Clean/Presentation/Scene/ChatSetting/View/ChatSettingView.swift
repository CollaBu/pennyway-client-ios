    ...
    var body: some View {
        ScrollView {
            VStack {
                ...
                // 채팅방 커버 수정 버튼
                CustomRoundedBtn(title: "채팅방 커버 변경", fontSize: .B2MediumFont(), fontColor: Color("Mint03"), backgroundColor: Color("Mint01"), horizontalPadding: 10, verticalPadding: 7, cornerRadius: 14) {
                    // 버튼 액션
                }
