...
//        .dragBottomSheet(isPresented: $viewModel.isCategoryListViewPresented) { offset in
//            SpendingCategoryListView(viewModel: viewModel, isPresented: $viewModel.isCategoryListViewPresented, offset: offset)
//        }
